...
module.exports = {
    ...
    csslibs: [ // 在index.html中需要引入的 css lib
        '/statics/vendor/element/index.css',
        '/statics/vendor/firebase/firebaseui.css'
    ],
    jslibs: [ // 在 index.html 中需要引入的 js lib， vue 和 router 必须引入，其余可选
        ...
        '/statics/vendor/firebase/firebase.js',
        '/statics/vendor/firebase/firebaseui.js',
        '/statics/vendor/element/index.js'
    ],
